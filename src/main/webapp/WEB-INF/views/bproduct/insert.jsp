		...
		<form id="myform" enctype="multipart/form-data" method="POST">
			<table border="1">
				...
				<tr>
					...
					<td align="center"><input type="text" id="productQuantity"
						name="productQuantity" placeholder="판매 수량 (숫자)" data-vc="1,1000"
						required></td>
				</tr>
				<tr>
					<td align="center">제품 최저가</td>
					<td align="center"><input type="text" id="productLowestPrice"
						name="productLowestPrice" placeholder="제품의 최저가"
						data-vc="1,1000000000"></td>
				</tr>
				<tr>
					<td align="center">제품 희망가</td>
					<td align="center"><input type="text" id="productHopefulPrice"
						name="productHopefulPrice" placeholder="제품 희망가(즉시 구매가)"
						data-vc="1,1000000000"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center"><input type="text" id="productCondition"
						name="productCondition" placeholder="제품의 상태(자세히)" data-vc="1,30">
					</td>
				</tr>
				<tr>
			...
			<img src="" id="preview"> <input type="file" accept="image/*">
